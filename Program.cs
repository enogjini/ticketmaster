...
{
    internal class Program // klasa kryesore e programit
    {
        static void Main(string[] args) // metoda kryesore Main
        {
            ITicketRepo repository = TicketRepoFactory.Create("json"); // përdorim Factory Pattern për repo
            TicketManager ticketService = TicketManager.GetInstance(repository); // përdorim Singleton Pattern për TicketManager
